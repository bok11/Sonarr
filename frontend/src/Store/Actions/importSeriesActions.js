...
export const CANCEL_IMPORT_SERIES = 'importSeries/icancelImportSeries';
...
export const cancelLookupSeries = createAction(CANCEL_IMPORT_SERIES);
...
export const reducers = createHandleActions({
  ...
  [CANCEL_IMPORT_SERIES]: function(state) {
